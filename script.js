...
function diminuiFonte() {
    if (tamanhoFonteAtual > 10) { // Limite mínimo para manter a leitura aceitável
        tamanhoFonteAtual -= valorSubtraido;
        document.documentElement.style.fontSize = `${tamanhoFonteAtual}px`;
    }
}

// --- LEITURA DE TELA EM VOZ ALTA (Web Speech API) ---
let lendo = false;
...
function lerEmVozAlta() {
    ...
    speechSynthesis.cancel(); // Limpa leituras anteriores
